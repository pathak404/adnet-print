...
<div class="auth-page bg-white">
    <div class="container text-center py-2 px-0">
        <div class="row">
                ...
                <div class="u-columns col2-set" id="customer_login">
                    ...
                    <div class="u-column1 col-1">
                        ...
                        <div class="w-100 h-100 d-flex align-items-center justify-content-center">
                            <form class="woocommerce-form woocommerce-form-login login p-2" method="post">

                                <div class="text-start mb-4">
                                    <h2 class="text-black">Login to manage your account & orders</h2>
                                </div>
                                ...
                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide hstack">
                                    <label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
                                        <input class="woocommerce-form__input woocommerce-form__input-checkbox"
                                               name="rememberme" type="checkbox" id="rememberme" value="forever"/>
                                        <span class="small" style="position: relative;top:-2px;"><?php esc_html_e( 'Remember me', 'woocommerce' ); ?></span>
                                    </label>
                                    <span class="woocommerce-LostPassword lost_password ms-auto">
                                    <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"
                                       class="small text-muted text-decoration-none"><?php esc_html_e( 'Lost your password?', 'woocommerce' ); ?></a>
                                </span>
                                </p>
                                ...
                                <p class="form-row woocommerce-form-row">
                                    ...
                                    <button type="submit"
                                            class="px-5 py-3 woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"
                                            name="login"
            ...
            <div class="col-12 col-md-6">
                <div class="w-100 h-100 d-flex align-items-center justify-content-center pt-3 pb-5 py-md-0">
                    <img src="<?php echo get_template_directory_uri() . '/assets/images/auth/DrawKit-Vector-Illustration-ecommerce-01.png' ?>"
